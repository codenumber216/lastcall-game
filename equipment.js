...
const EQUIPMENT = {
  ...
  // ※ SSOT 미정 → 0 (기획 리포트). 도감 슬롯·장착은 유지, 전투 효과만 보류.
  accessory_atk_by_grade: { 일반: 0, 고급: 0, 희귀: 0, 영웅: 0, 전설: 0 },   // 장신구 M_atk %
  shield_survive_by_grade: { 일반: 0, 고급: 0, 희귀: 0, 영웅: 0, 전설: 0 },   // 방패 피해감소(also_armor)
